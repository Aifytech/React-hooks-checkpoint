...
const Index = () => {
  ...
  const filteredMovies = movies.filter(movie => {
    ...
    const matchesRating = !filters.minRating || movie.rating >= parseFloat(filters.minRating);
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Discover amazing movies and TV shows</p>
              </div>
            </div>
